    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        serviceReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ProviderServiceActivity.this);
                recyclerView.setLayoutManager(layoutManager);

                // Specify an adapter (see also next example)
                adapter = new ServiceAdapter(data, ProviderServiceActivity.this);
